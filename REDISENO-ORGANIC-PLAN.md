...
- **RF-042 a 045 — Portal del propietario** (Módulo 8 nuevo): cita la sección 1 ("El propietario no es usuario del sistema") — el punto de mayor tensión con el alcance original, mismo peso que Módulo 6, con aclaración explícita de que RN-006 sigue intacto (el portal nunca expone diagnóstico/hallazgos/tratamiento). **Nota (2026-08-26):** el flujo de alta de RF-042 cambió después del cierre de este plan — pasó de un acto explícito de Recepción a un alta automática al registrar un paciente, con envío de credenciales por correo. Este archivo documenta lo que se planeó y ejecutó en la Fase 5 tal como ocurrió entonces; el detalle completo de la ampliación posterior vive en CLAUDE.md §14 ("Ampliación posterior a la Fase 5").
